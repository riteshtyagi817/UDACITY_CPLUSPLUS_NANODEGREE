...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
  ...
  for(auto eachnode:current_node->neighbors)
  {
    ...
    eachnode->h_value = RoutePlanner::CalculateHValue(eachnode);
    eachnode->visited = true;
    RoutePlanner::open_list.emplace_back(eachnode);
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
  ...
  /*if(current_node == start_node)
  {
    std::cout << "after while in testconstruct" << std::endl; 
    distance += current_node->distance(*(current_node->parent));
    path_found.push_back(*current_node);
  } */
  ...
  {
    std:: cout << path_found[i].x << std::endl;
  } */
...
void RoutePlanner::AStarSearch() {
  ...
  if(current_node == end_node)
  {
    //std::cout <<"this condition is matching" << std::endl;
    path = RoutePlanner::ConstructFinalPath(current_node);
